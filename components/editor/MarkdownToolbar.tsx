...
import { Code2, Heading2, Heading3, Link2, List, ListOrdered, Minus, Quote, SquareCheck, Undo2, Redo2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-wrap items-center gap-0 border-b border-[var(--color-border)] bg-transparent px-8 py-3">
      ...
      <div className="ml-auto flex items-center gap-2">
        <button type="button" className="toolbar-btn" title="Undo (Ctrl+Z)" onClick={() => onFormat('undo')}>
          <Undo2 size={14} strokeWidth={1.5} />
        </button>
        <button type="button" className="toolbar-btn" title="Redo (Ctrl+Y)" onClick={() => onFormat('redo')}>
